...
#ifndef RANK_UTILITIES_LOOKUP3_H_
#define RANK_UTILITIES_LOOKUP3_H_
...
#endif  // RANK_UTILITIES_LOOKUP3_H_
...
void driver3() {
  ...
  uint32_t len;
  uint8_t q[] =
      "This is the time for all good men to come to the aid of their "
      "country...";
  uint32_t h;
  uint8_t qq[] =
      "xThis is the time for all good men to come to the aid of their "
      "country...";
  uint32_t i;
  uint8_t qqq[] =
      "xxThis is the time for all good men to come to the aid of their "
      "country...";
  uint32_t j;
  uint8_t qqqq[] =
      "xxxThis is the time for all good men to come to the aid of their "
      "country...";
  uint32_t ref, x, y;
  uint8_t *p;

  printf(
      "Endianness.  These lines should all be the same (for values filled "
      "in):\n");
  printf(
      "%.8x                            %.8x                            %.8x\n",
